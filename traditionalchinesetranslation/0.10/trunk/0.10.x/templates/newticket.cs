...
<form id="newticket" method="post" action="<?cs
 ...
 /if ?>
 <div class="field">
  <label for="description">完整敘述 (<a tabindex="42" href="<?cs
...
<div id="help">
 <strong>提示:</strong> 查看本頁相關幫助 <a href="<?cs
   var:trac.href.wiki ?>/ZhTracTickets">待辦事項</a> 
</div>
</div>
