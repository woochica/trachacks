...
<form id="newticket" method="post" action="<?cs
 ...
 <fieldset id="properties">
  <legend>W³a¶ciwio¶ci Ticket</legend>
 ...
 <div class="buttons">
  ...
  <input type="submit" value="Wy¶lij ticket" />
 </div>
</form>

<div id="help">
 <strong>Pomoc:</strong> Zobacz <a href="<?cs
   var:trac.href.wiki ?>/TracTickets">TracTickets</a>, aby uzyskaæ dodatkowe informacje na temat u¿ywania tickets.
</div>
</div>
