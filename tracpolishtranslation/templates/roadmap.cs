...
<div id="content" class="roadmap">
 ...
 <form id="prefs" method="get" action="">
  <div>
   ...
   <label for="showall">Poka¿ ukoñczone wersje planu</label>
  </div>
  <div class="buttons">
   ...
   <div class="info">
    ...
    <p class="date"<?cs
     if:milestone.completed_date ?> title="<?cs var:milestone.completed_date ?>">
      Zakoñczono <?cs var:milestone.completed_delta ?> temu<?cs
 ...
 <div id="help">
  <strong>Pomoc:</strong> Zobacz <a href="<?cs
    var:trac.href.wiki ?>/TracRoadmap">TracRoadmap</a>, aby przeczytaæ wiêcej na temat planowania.
 </div>
