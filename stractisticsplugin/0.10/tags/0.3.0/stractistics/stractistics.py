...
# USA
#
# $Id: stractistics.py 359 2008-03-14 08:27:48Z ddgb $
#
...
class StractisticsModule(Component):
    ...
    def _repository_activity(self, args):
        ...
        ignored_authors = [str(elem) for elem in self.env.config.getlist(\
                                                'stractistics',
                                                'ignored_repository_authors',
                                                default=[])]
        ignored_authors = self._quote_authors(ignored_authors)
