...
<div id="content">
	<form id="prefs" method="get">
		<div>
			<label>View activity from <input type="text" size="7" name="end_date" value="<?cs var:timeframe.end_date ?>" /></label> and <label><input type="text" size="3" name="weeks_back" value="<?cs var:timeframe.weeks_back ?>" /> weeks back</label>.
		</div>
		<div class="buttons">
