...
<div id="ctxtnav" class="nav">
 ...
 <ul><?cs
  if:wiki.action == "diff" ?>
   ...
   <li><a href="<?cs var:trac.href.wiki ?>/TitleIndex">标题索引</a></li>
   <li><a href="<?cs var:trac.href.wiki ?>/RecentChanges">日期索引</a></li>
...
<?cs var:wiki.page_source ?></textarea></p>
    ...
    <div id="help">
     <b>提示:</b>查看<a href="<?cs var:$trac.href.wiki
?>/WikiFormatting">WikiFormatting</a> 与 <a href="<?cs var:$trac.href.wiki
?>/TracWiki">TracWiki</a> 对本页面的帮助.
    </div>
