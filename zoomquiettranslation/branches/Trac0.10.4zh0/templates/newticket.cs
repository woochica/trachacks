...
<form id="newticket" method="post" action="<?cs
 ...
 /if ?>
 <div class="field">
  <label for="description">完整描述 (可使用排板手册 <a tabindex="42" href="<?cs
...
<?cs var:newticket.description ?></textarea><?cs
 ...
 <div class="buttons">
  ...
  <input type="submit" value="发送传票" />
 </div>
</form>

<div id="help">
 <strong>Note:</strong> 查看 <a href="<?cs
   var:trac.href.wiki ?>/TracTickets">TracTickets</a> 对本页面的帮助信息.
</div>
</div>
