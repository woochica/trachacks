...
class QueryModule(Component):
    ...
    def display_html(self, req, query):
        ...
        ZhCol = {'Id':u'传票号','Status':u'状态','Priority':u'优先级','Report':u'报表','Title':u'标题','Ticket':u'传票','Summary':u'描述','Component':u'组件','Version':u'版本','Milestone':u'里程碑','Type':u'类型','Owner':u'属主','Created':u'创建日期'}
        for idx, col in enumerate(cols):
            req.hdf['query.headers.%d' % idx] = {
                'name': col, 'label': ZhCol.get(col.capitalize(), col),
