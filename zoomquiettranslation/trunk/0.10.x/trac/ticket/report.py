 ...
 * 先显示组内登录用户的所有传票。'''}
        ...
        try:
            ...
            ZhCols = {'Report':u'#','Title':u'标题','Ticket':u'传票','Summary':u'描述','Component':u'组件','Version':u'版本','Milestone':u'里程碑','Type':u'类型','Owner':u'属主','Created':u'创建日期'}
        except Exception, e:
