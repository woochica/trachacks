...
<table>
    <tr>
        <td>
            <form method="post" action="<?cs var:trac.href.peerReviewView ?>?Review=<?cs var:reviewID ?>&Vote=yes">
            <input type="submit" value="Approve">
            </form>
        </td>
        <td>
            <form method="post" action="<?cs var:trac.href.peerReviewView ?>?Review=<?cs var:reviewID ?>&Vote=no">
...
<table valign="middle">
    <tr>
        ...
        <td width = 30px></td>
        <td>
            <form method="post" action="<?cs var:trac.href.peerReviewNew ?>?resubmit=<?cs var:reviewID?>">
...
<table>
	<tr>
		<td>
			<form method="post" action="<?cs var:trac.href.peerReviewView ?>?Review=<?cs var:reviewID?>&Inclusion=1">
        ...
        <?cs if:status != "Closed" ?>
		<td>
			<form method="post" action="<?cs var:trac.href.peerReviewView ?>?Review=<?cs var:reviewID?>&Close=1">
