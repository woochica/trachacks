...
<div id="content" class="browser">
 ...
 if:!browser.is_dir ?>
  ...
  Start Line: <input type=text value="" size="5" id="lineBox1" onchange="addButtonEnable()">&nbsp;&nbsp
  End Line: <input type=text value="" size="5" id="lineBox2" onchange="addButtonEnable()">
