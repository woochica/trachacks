<!-- Code behind = performCodeReview.py -->
...
<br>
<!-- table containing information for the file being reviewed - values are set in Python -->
...
<br>
Back to the<a href="<?cs var:trac.href.viewCodeReview ?>?Review=<?cs var:review.reviewID ?>"> Code Review Details</a> page
<br><br>
...
<table width="300px" bgcolor="#F7F7F7" style="border-collapse: collapse;">
  ...
  <tr id="AddCommentAttachArea" style="visibility: hidden; height: 0px;">
	...
	<iframe frameborder="0" name="internalAddComment" id="internalAddComment" marginHeight="0" marginWidth="0" style="height: 0px; width:286px" src="<?cs var:trac.href.commentCallback ?>"></iframe>&nbsp;
    </td>
  </tr>
  <tr>
...
<!-- hides lines in the file preview area that the user does not currently want to see -->
function hideLines()
{
    var i = 1;
    var row = null;
...
<!-- validates line option from user, then calls hideLines() -->
function resetLines()
{
...
var baseUrl = "<?cs var:trac.href.commentCallback ?>";
