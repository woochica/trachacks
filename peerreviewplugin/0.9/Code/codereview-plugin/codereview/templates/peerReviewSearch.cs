		...
		<tbody>
			<?cs each:item = results ?>
				<tr class="<?cs if:name(item) % #2 ?>even<?cs else ?>odd<?cs /if ?>">
					...
					<?cs if:item[2] != "" ?>
						<td><a href="<?cs var:trac.href.viewCodeReview ?>?Review=<?cs var:item[0]?>"><?cs var:item[0]?></a></td>
						<td><a href="<?cs var:trac.href.viewCodeReview ?>?Review=<?cs var:item[0]?>"><?cs var:item[1]?></a></td>
						<td><a href="<?cs var:trac.href.viewCodeReview ?>?Review=<?cs var:item[0]?>"><?cs var:item[2]?></a></td>
						<td><a href="<?cs var:trac.href.viewCodeReview ?>?Review=<?cs var:item[0]?>"><?cs var:item[4]?></a></td>
						<td><a href="<?cs var:trac.href.viewCodeReview ?>?Review=<?cs var:item[0]?>"><?cs var:item[3]?></a></td>
					<?cs /if ?>
					<?cs if:item[2] == "" ?>
						<td><?cs var:item[0]?></td>
						<td><?cs var:item[1]?></td>
