...
types = {
    ...
    'text/x-php':               ('html+php', 9),
    'application/x-httpd-php':  ('html+php', 9),
    'application/x-httpd-php3': ('html+php', 9),
    'application/x-httpd-php4': ('html+php', 9),
    'application/x-httpd-php5': ('html+php', 9),
