"""
 ...
 functions for their bibtexparer. I added just some fixes (e.g. BibTex does not
 allow comments starting with '#', which was assumed by the previous authors).
...
"""
  ...
  3. Added handling of accents and some other latex tags (incomplete) through a
     translation table
  4. Handling of a few LaTeX math constructions.

  5. There were some small bugs, when one of the fields (I found them in url or
     abstract)
  ...
  2.  Does not parse author fields into first and last names.
      ...
      In "author" tag, will show up as <bibxml:author>LAST_NAME,
      FIRST_NAME</bibxml:author>
...
# Accents and other latin symbols
accent_tags = [
    (r'\"a', "&#228;"),
    (r"\`a", "&#224;"),
    (r"\'a", "&#225;"),
