...
<?cs if:len(search.result) ?>
 <hr />
 <h2>Résultats de la recherche <?cs
 ...
 <div id="notfound">Aucune correspondance trouvée.</div><?cs
/if ?>

<div id="help">
 <strong>Note:</strong> Voir <a href="<?cs
   var:trac.href.wiki ?>/TracSearch">TracSearch</a> pour de l'aide sur la recherche.
</div>
