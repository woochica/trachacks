...
class NotifyEmail(Notify):
    ...
    def notify(self, resid, subject):
        ...
        if not self.from_email and not self.replyto_email:
            raise TracError("Impossible de poster un courriel à cause d'une crise identitaire. <br />"
                            "Ni <b>notification.from</b> ni <b>notification.reply_to</b> ne sont "
                            "précisés dans la configuration du projet.",
                            "Notification Erreur SMTP")
